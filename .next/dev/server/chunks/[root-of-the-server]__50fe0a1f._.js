...
"[project]/Desi-Ngl/pages/api/admin/messages.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        try {
            ...
            const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["messageModal"].find(query).select('message mood createdAt reactions replies senderMeta').populate('userId', 'username').sort({
                createdAt: -1
            }).skip(skip).limit(parseInt(limit)).lean();
            const totalMessages = await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["messageModal"].countDocuments(query);
    ...
    if (req.method === 'DELETE') {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["messageModal"].findByIdAndDelete(messageId);
            return res.status(200).json({
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50fe0a1f._.js.map