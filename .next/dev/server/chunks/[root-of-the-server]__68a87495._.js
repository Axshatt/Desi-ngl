...
"[project]/Desi-Ngl/pages/api/admin/users.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        try {
            ...
            const users = await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["userModal"].find(query).select('username createdAt').sort({
                createdAt: -1
            }).skip(skip).limit(parseInt(limit)).lean();
            // Get message counts for each user
            const usersWithStats = await Promise.all(users.map(async (user)=>{
                const messageCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["messageModal"].countDocuments({
                    userId: user._id
                });
                return {
                    ...user,
            ...
            const totalUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["userModal"].countDocuments(query);
    ...
    if (req.method === 'DELETE') {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["messageModal"].deleteMany({
                userId
            });
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desi$2d$Ngl$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["userModal"].findByIdAndDelete(userId);
            return res.status(200).json({
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68a87495._.js.map