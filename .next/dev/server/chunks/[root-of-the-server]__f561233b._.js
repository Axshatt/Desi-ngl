...
"[project]/Desi-Ngl/pages/api/stripe/mock-success.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        res.setHeader('Location', `/admin/message/${decoded.username}?premium=true`);
        res.statusCode = 302;
        res.end();
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f561233b._.js.map